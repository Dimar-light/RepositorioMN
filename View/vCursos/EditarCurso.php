<?php
    include_once $_SERVER['DOCUMENT_ROOT'] . '/RepositorioMN/Controller/CursoController.php';
    include_once $_SERVER['DOCUMENT_ROOT'] . '/RepositorioMN/View/LayoutInterno.php';
