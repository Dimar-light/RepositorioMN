            ...
            <div class="card-body p-5">
                ...
                <form class="needs-validation mt-3" novalidate>
                    ...
                    <div class="mb-3">
                        ...
                        <input id="nombreCompleto" type="text" class="form-control" required>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input id="contrasena" type="text" class="form-control" required minlength="6">
                    </div>
                ...
                <div class="text-center mt-3 small text-muted">
                    ¿Ya tienes una cuenta? <a href="IniciarSesion.html" class="link-primary">Inicie Sesión</a>
                </div>
            </div>
        </div>
    </div>
